...
const char *ALIBAVA::ALIBAVACLUSTER_ENCODE = "ClusterID:6,IsSensitiveAxisX:1,"
                                             "IsSignalNegative:1,ChipNum:1,"
                                             "ClusterSize:8,Seed:16";
const char *ALIBAVA::ALIBAVACLUSTER_ENCODE_CLUSTERID = "ClusterID";
const char *ALIBAVA::ALIBAVACLUSTER_ENCODE_ISSENSITIVEAXISX =
    "IsSensitiveAxisX";
const char *ALIBAVA::ALIBAVACLUSTER_ENCODE_ISSIGNALNEGATIVE =
    "IsSignalNegative";
...
string getSubStringUpToChar(string search_string, const char *search_char,
                            size_t start_position) {
  size_t found_position = search_string.find(search_char, start_position);
  if (found_position == string::npos)
    found_position = search_string.size();
