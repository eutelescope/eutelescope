...
AlibavaPedestalSubtraction::AlibavaPedestalSubtraction()
  ...
  _description = "AlibavaPedestalSubtraction subtracts the provided pedestal "
                 "values from the input raw data. ";
...
void AlibavaPedestalSubtraction::fillHistos(TrackerDataImpl * /* trkdata */) {
  // nothing is done here, if you want to plot histograms use
  // AlibavaHistogramMaker processor
}
