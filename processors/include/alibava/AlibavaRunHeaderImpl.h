...
namespace alibava {
  ...
  /*! This is used to store the run header into the LCIO files produced
        ...
        *  around the LCRunHeaderImpl. The following parameters have been
   defined:
   *
   ...
   *
        ...
        // Based on EUTelRunHeaderImpl.cc written by Antonio Bulgheroni, INFN
  ...
  public:
    ...
    */
    ...
    inline EVENT::FloatVec getHeaderPedestal() const {
      ...
      v_ped =
          _lcHeader->parameters().getFloatVals(ALIBAVA::HEADERPEDESTAL, v_ped);
      return v_ped;
    }
    ...
    inline EVENT::FloatVec getHeaderNoise() const {
      ...
      v_noise =
          _lcHeader->parameters().getFloatVals(ALIBAVA::HEADERNOISE, v_noise);
      return v_noise;
    }
