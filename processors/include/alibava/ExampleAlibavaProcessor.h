...
#ifndef ExampleAlibavaProcessor_H
#define ExampleAlibavaProcessor_H 1
...
namespace alibava {
  ...
  class ExampleAlibavaProcessor : public alibava::AlibavaBaseProcessor {

  public:
    //! Returns a new instance of ExampleAlibavaProcessor
    /*! This method returns an new instance of the this processor.  It
     *  is called by Marlin execution framework and it shouldn't be
     *  called/used by the final user.
     *
     *  @return a new ExampleAlibavaProcessor.
     */
    virtual Processor *newProcessor() { return new ExampleAlibavaProcessor; }

    //! Default constructor
    ExampleAlibavaProcessor();
     ...
     *  is just calling
     *  ExampleAlibavaProcessor::firstLoop(LCEvent*) or
     *  ExampleAlibavaProcessor::otherLoop(LCEvent*)
     *
     ...
     *  histograms listed in ExampleAlibavaProcessor::fillHistos()
     *  there is also a common mode histo described here below:
     *
     *  @see ExampleAlibavaProcessor::fillHistos() for the todos
     */
    void bookHistos();
  ...
  ExampleAlibavaProcessor gExampleAlibavaProcessor;
}
