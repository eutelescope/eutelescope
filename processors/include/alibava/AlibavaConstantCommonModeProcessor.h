...
namespace alibava {
  ...
  class AlibavaConstantCommonModeProcessor
      : public alibava::AlibavaBaseProcessor {
  ...
  public:
     ...
     * will be considered as signal and not be included in common mode error
     * calculation
     */
    ...
    void
    setCommonModeErrorCollectionName(std::string CommonModeErrorCollectionName);
