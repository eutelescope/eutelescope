...
namespace alibava {
  ...
  public:
    //! Returns a new instance of AlibavaTimeCutProcessor
    /*! This method returns an new instance of the this processor.  It
     *  is called by Marlin execution framework and it shouldn't be
     *  called/used by the final user.
     *
     *  @return a new AlibavaTimeCutProcessor.
     */
    virtual Processor *newProcessor() { return new AlibavaTimeCutProcessor; }
     ...
     *  is just calling
     *  AlibavaTimeCutProcessor::firstLoop(LCEvent*) or
     *  AlibavaTimeCutProcessor::otherLoop(LCEvent*)
     *
     ...
     *  histograms listed in AlibavaTimeCutProcessor::fillHistos()
     ...
     *  updated every event.
     *
     *  @see AlibavaTimeCutProcessor::fillHistos() for the todos
     */
    void bookHistos();
