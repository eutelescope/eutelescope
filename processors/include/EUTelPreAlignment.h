...
namespace eutelescope {
  ...
  public:
    ...
    float getPeakX() { return ((getMaxBin(histoX) * pitchX) + minX); }
    float getPeakY() { return ((getMaxBin(histoY) * pitchY) + minX); }
  ...
  public:
    virtual Processor *newProcessor() { return new EUTelPreAlign; }
    //! Default constructor
    EUTelPreAlign();
    virtual void init();
