...
public:
  virtual Processor *newProcessor() {
    return new EUTelProcessorAnalysisPALPIDEfs;
  }
  ...
  bool RemoveAlign(LCCollectionVec *preAlignmentCollectionVec,
                   LCCollectionVec *alignmentCollectionVec,
                   LCCollectionVec *alignmentPAlpideCollectionVec,
                   double *fitpos, double &xposfit, double &yposfit);
...
private:
  ...
  enum statsEntry : int {
    ...
    kGoodTimeStamp,
    kDataAvailable,
    kFittedHitsAvailable,
    kTracksAvailable,
    kAlignAvailable,
    kOnlyOneAlignAvailable,
    kClustersAvailable,
    kSingularRotationMatrix,
    kFittedHit,
    kTwoCloseTracks,
    kTwoCloseTracksRejected,
    kZposCorrect,
    kZposWrong,
    kAlignmentRemoved,
    kAlignmentRemovalFailed,
    kFittedHitOnChip,
    kFittedHitNotOnChip,
    kFittedHitInBorderRegion,
    kUnknownSector,
    kHotPixel,
    kMaskedPixel,
    kDeadColumn,
    kHitsOnTheSamePlane,
    kSingleHitsOnly,
    kRejectedMultipleHits,
    kDenominator,
    kHitInDUT,
    kAssociatedHitInDUT,
    kNoHitInDUT,
    kHitNotInDUT,
    kHitInDUTNotAssociated,
    kHitNULL
  };
};
