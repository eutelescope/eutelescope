...
EUTelMuPixel::EUTelMuPixel()
    : EUTelGenericSparsePixel(), _hitTime(0), _frameTime(0) {
...
EUTelMuPixel::EUTelMuPixel(short xCoord, short yCoord, float signal, short time,
                           short hitTime, long long unsigned frameTime)
    : EUTelGenericSparsePixel(xCoord, yCoord, signal, time), _hitTime(hitTime),
...
EUTelMuPixel::EUTelMuPixel(EUTelGenericSparsePixel &genericPixel)
    : EUTelGenericSparsePixel(genericPixel), _hitTime(0), _frameTime(0) {
  _noOfElementsDerived = 7;
  _typeDerived = kEUTelMuPixel;
}

// Constructor taking a EUTelGenericSparsePixel and the two time stamps
EUTelMuPixel::EUTelMuPixel(EUTelGenericSparsePixel &genericPixel, short hitTime,
                           long long unsigned frameTime)
    : EUTelGenericSparsePixel(genericPixel), _hitTime(hitTime),
      _frameTime(frameTime) {
  _noOfElementsDerived = 7;
  _typeDerived = kEUTelMuPixel;
}
