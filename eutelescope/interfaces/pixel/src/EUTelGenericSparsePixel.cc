...
EUTelGenericSparsePixel::EUTelGenericSparsePixel()
    : _xCoord(0), _yCoord(0), _signal(0), _time(0) {
  _noOfElements = 4;
  _type = kEUTelGenericSparsePixel;
}

// Constructor with all four parameters
EUTelGenericSparsePixel::EUTelGenericSparsePixel(short xCoord, short yCoord,
                                                 float signal, short time)
    : _xCoord(xCoord), _yCoord(yCoord), _signal(signal), _time(time) {
  _noOfElements = 4;
  _type = kEUTelGenericSparsePixel;
}
...
EUTelGenericSparsePixel::EUTelGenericSparsePixel(short xCoord, short yCoord,
                                                 float signal)
    : _xCoord(xCoord), _yCoord(yCoord), _signal(signal), _time(0) {
  _noOfElements = 4;
  _type = kEUTelGenericSparsePixel;
}
