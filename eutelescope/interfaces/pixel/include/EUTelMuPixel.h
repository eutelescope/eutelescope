...
namespace eutelescope {
  ...
  public:
    ...
    EUTelMuPixel(short xCoord, short yCoord, float signal, short time,
                 short hit_time, long long unsigned frame_time);

    //! Default constructor with all arguments (EUTelGenericSparsePixel, 2
    //! additional time stamps)
    EUTelMuPixel(EUTelGenericSparsePixel &genericPixel, short hit_time,
                 long long unsigned frame_time);
