...
namespace eutelescope {
  ...
  public:
    //! Default constructor
    EUTelVirtualCluster(IMPL::TrackerDataImpl *data)
    ...
    getClusterCharge(std::vector<int> nPixels) const = 0;
     ...
     */
    virtual void getCenterOfGravityShift(float &x, float &y, int xSize,
                                         int ySize) const = 0;
     ...
     */
    virtual std::vector<float>
    getClusterSNR(std::vector<int> nPixels) const = 0;
