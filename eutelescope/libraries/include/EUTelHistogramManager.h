...
namespace eutelescope {
  ...
  public:
    ...
    friend std::ostream &operator<<(std::ostream &os,
                                    const EUTelHistogramInfo &histoInfo) {
      os << "===============================================\n"
         << "| Name         " << histoInfo._name << std::endl;
      if (histoInfo._title != "")
        os << "| Title        " << histoInfo._title << std::endl;
      os << "| Type         " << histoInfo._type << std::endl;

      if ((histoInfo._type == "H1D") || (histoInfo._type == "H2D") ||
          (histoInfo._type == "H3D") || (histoInfo._type == "P1D") ||
          (histoInfo._type == "P2D")) {
      ...
      if ((histoInfo._type == "H2D") || (histoInfo._type == "H3D") ||
          (histoInfo._type == "P2D")) {
  ...
  public:
     ...
     */
    EUTelHistogramManager(std::string histoInfoFileName)
        : _histoInfoFileName(histoInfoFileName), _histoInfoMap() {
      ;
    }
