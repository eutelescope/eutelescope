...
EUTelReferenceHit::EUTelReferenceHit()
...
EUTelReferenceHit::EUTelReferenceHit(int sensorID, double xOff, double yOff,
                                     double zOff, double alpha, double beta,
                                     double gamma)
    :
...
void EUTelReferenceHit::print(ostream &os) const {
  ...
  os << dashline << endl
     ...
     << setw(largeWidth) << " Z off [mm] " << setw(largeWidth) << " X angle "
     << setw(largeWidth) << " Y angle " << setw(largeWidth) << " Z angle "
     << endl
