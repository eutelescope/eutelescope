...
AlibavaHitMaker::AlibavaHitMaker () :
AlibavaBaseProcessor("AlibavaHitMaker")
{
	
	// modify processor description
	_description =
	"AlibavaHitMaker takes AlibavaCluster collection and forms hits ";
...
void AlibavaHitMaker::processRunHeader (LCRunHeader * rdr) {
...
void AlibavaHitMaker::processEvent (LCEvent * anEvent) {
...
void AlibavaHitMaker::check (LCEvent * /* evt */ ) {
	// nothing to check here - could be used to fill check plots in reconstruction processor
}


void AlibavaHitMaker::end() {
...
void AlibavaHitMaker::fillHistos(TrackerDataImpl * /* trkdata */){
	// this is an example
...
void AlibavaHitMaker::bookHistos(){
	// this is an example
	/*
