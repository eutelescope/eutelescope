...
AlibavaSimConverter::AlibavaSimConverter () :
AlibavaBaseProcessor("AlibavaSimConverter")
{

	_description = "AlibavaSimConverter converts allpix simulated data into alibava lcio data!";
