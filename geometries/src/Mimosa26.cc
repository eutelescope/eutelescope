...
namespace eutelescope {
  namespace geo {
    ...
    Mimosa26::Mimosa26()
        : EUTelGenericPixGeoDescr(21.2, 10.6, 0.02, // size X, Y, Z
    ...
    std::string Mimosa26::getPixName(int x, int y) {
      ...
      snprintf(buffer, 100, "/sensarea_mimosa_1/mimorow_%d/mimopixel_%d", x + 1,
               y + 1);
      return std::string(buffer);
    }
    /*TODO*/ std::pair<int, int> Mimosa26::getPixIndex(char const *) {
