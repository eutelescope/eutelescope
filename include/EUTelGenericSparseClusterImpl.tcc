...
template<class EUTelGeometricPixel>
void EUTelGenericSparseClusterImpl<EUTelGeometricPixel>::getClusterGeomInfo(float& xPos, float& yPos, float& xSize, float& ySize) const 
{
