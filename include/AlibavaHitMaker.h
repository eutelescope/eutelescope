...
#ifndef ALIBAVAHITMAKER_H
#define ALIBAVAHITMAKER_H 1
...
namespace alibava {
	...
	class AlibavaHitMaker:public alibava::AlibavaBaseProcessor   {
		
	public:
		
		
		//! Returns a new instance of AlibavaHitMaker
		/*! This method returns an new instance of the this processor.  It
		 *  is called by Marlin execution framework and it shouldn't be
		 *  called/used by the final user.
		 *
		 *  @return a new AlibavaHitMaker.
		 */
		virtual Processor * newProcessor () {
			return new AlibavaHitMaker;
		}
		 ...
		 *  is just calling
		 *  AlibavaHitMaker::firstLoop(LCEvent*) or
		 *  AlibavaHitMaker::otherLoop(LCEvent*)
		 *
		 ...
		 *  histograms listed in AlibavaHitMaker::fillHistos()
		 *  there is also a common mode histo described here below:
		 *
		 *  @see AlibavaHitMaker::fillHistos() for the todos
		 */
		void bookHistos();
	...
	AlibavaHitMaker gAlibavaHitMaker;
