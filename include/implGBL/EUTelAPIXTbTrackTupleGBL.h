...
namespace eutelescope {
  class EUTelAPIXTbTrackTupleGBL : public marlin::Processor {
  
  public:
    virtual Processor*  newProcessor() { return new EUTelAPIXTbTrackTupleGBL; }
    
    EUTelAPIXTbTrackTupleGBL() ;
    virtual void init() ;
  ...
  EUTelAPIXTbTrackTupleGBL aEUTelAPIXTbTrackTupleGBL;
}
#endif
