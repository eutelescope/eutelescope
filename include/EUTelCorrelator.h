...
namespace eutelescope {
  ...
  private:
   ...
   //! First pixel along X
    ...
    std::map< unsigned int , std::map< unsigned int , AIDA::IHistogram2D* > > _hitXYCorrelationMatrix;
    std::map< unsigned int , std::map< unsigned int , AIDA::IHistogram2D* > > _hitYXCorrelationMatrix;
