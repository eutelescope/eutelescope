...
#ifndef ALIBAVADATATTREEMAKER_H
#define ALIBAVADATATTREEMAKER_H 1
...
namespace alibava {
    ...
    class AlibavaDataTTreeMaker :  public alibava::AlibavaBaseProcessor  {
        
    public:
        
        
        //! Returns a new instance of AlibavaDataTTreeMaker
        /*! This method returns an new instance of the this processor.  It
         *  is called by Marlin execution framework and it shouldn't be
         *  called/used by the final user.
         *
         *  @return a new AlibavaDataTTreeMaker.
         */
        virtual Processor * newProcessor () {
            return new AlibavaDataTTreeMaker;
        }
        
        //! Default constructor
        AlibavaDataTTreeMaker ();
         ...
         *  is just calling
         *  AlibavaDataTTreeMaker::firstLoop(LCEvent*) or
         *  AlibavaDataTTreeMaker::otherLoop(LCEvent*)
         *
         ...
         *  histograms listed in AlibavaDataTTreeMaker::fillHistos()
         *  there is also a common mode histo described here below:
         *
         *  @see AlibavaDataTTreeMaker::fillHistos() for the todos
         */
    ...
    AlibavaDataTTreeMaker gAlibavaDataTTreeMaker;
