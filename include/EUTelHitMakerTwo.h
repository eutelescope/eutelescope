 ...
 *
 */
#ifndef EUTELHITMAKERTWO_H
#define EUTELHITMAKERTWO_H
...
namespace eutelescope {
  ...
  class EUTelHitMakerTwo : public marlin::Processor {

  private:
      DISALLOW_COPY_AND_ASSIGN(EUTelHitMakerTwo)
      
  public:


    //! Returns a new instance of EUTelHitMakerTwo
    /*! This method returns a new instance of this processor.  It is
     *  called by Marlin execution framework and it shouldn't be
     *  called/used by the final user.
     *
     *  @return a new EUTelHitMakerTwo.
     */
    virtual Processor * newProcessor() {
      return new EUTelHitMakerTwo;
    }
     ...
     */
    void bookHistos(int sensorID, bool isDUT);
  ...
  EUTelHitMakerTwo gEUTelHitMakerTwo;
