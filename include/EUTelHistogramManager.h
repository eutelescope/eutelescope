...
namespace eutelescope {
   ...
   *  @Version $Id: EUTelHistogramManager.h,v 1.1 2007-06-17 22:41:19 bulgheroni Exp $
   */ 

  class EUTelHistogramManager : public EUTelVirtualCluster {

  public:
    //! Default constructor
    EUTelHistogramManager(TrackerDataImpl * data);
   
    //! Destructor
    virtual ~EUTelHistogramManager() { /* NOOP */ ; }
