def runConfig(params):
    ...
    params["TelAlignmentDb"] = "run30080-alignment-tel-db.slcio"
    params["DutAlignmentDb"] = "run30080-alignment-dut-db.slcio"
    params["NoiseDb"]        = "run30080-noise-db.slcio"
    params["DataSet"] = "[30080, 30081, 30082, 30083, 30084, 30085, 30086, 30087]"
...
def aligndut(params):
    ...
    params["ResidualXMin"] = "2600 2000"#" 2500 -5500 "
    params["ResidualXMax"] = "3300 2500"#" 3150 -5000 "
    params["ResidualYMin"] = "-50  -1400"#" 100   3550 "
    params["ResidualYMax"] = "250  -1100"#" 350   3850 " 
