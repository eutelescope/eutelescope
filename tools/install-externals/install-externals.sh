...
wget -P "$tempdir" 'https://github.com/rootpy/rootpy/archive/'${rootpyversion}.tar.gz
...
eigenversion="3.2.0"
wget -P "$tempdir" 'http://bitbucket.org/eigen/eigen/get/'${eigenversion}.tar.gz
...
wget -P "$tempdir" 'https://github.com/simonspa/CMSPixelDecoder/archive/'${cmxpixeldecoderversion}.tar.gz
