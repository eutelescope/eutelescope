...
export ResidualsRMax="2" #This is the window size on the next plane that we will accept hits from. This will increase if less than 1 track per event is found.
export inputGearInitial="gear-noDUTs-aligned-613.xml" #Note the gear file changes through the process so must be placed here.
