...
export ExcludePlanes="6 7" #These planes are completely excluded from the analysis. The scattering from the plane however is still taken into account.
...
export inputGearInitial="gear-stripSensor.xml"
#export inputGearInitial="gear-final-noDUT-${RUN}.xml"
export outputIdentifier="final-no-DUTs-30k-Events-R=1" #Use this string to identify final gear/histogram and all iterations before.
