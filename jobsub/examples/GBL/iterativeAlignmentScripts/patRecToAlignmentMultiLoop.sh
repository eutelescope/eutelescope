...
export histoNameInput="GBLtrack-XYShift-${outputIdentifier}-Iteration-$number-${RUN}" 
...
export histoNameInput="GBLtrack-ZRotations-XYShifts-${outputIdentifier}-Iteration-$number-${RUN}"
$scriptsLocation/patRecToAlignmentSingleLoop.sh
$scriptsLocation/patRecAndTrackFit.sh -i "$outputGear" -h "$histoNameInput"  
echo "We have produced new histogram $histoNameInput"
