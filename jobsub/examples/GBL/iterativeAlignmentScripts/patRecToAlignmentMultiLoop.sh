...
export Fxs="$allMimosaPlanesFixed $ExcludePlanes" #This is the fixed planes for shifts in the x axis. Note we use exclude planes here so we can sometimes let dut alignment parameters free
export Fyr="0 1 2 3 4 5 $dutPlanes" #This is the fixed planes for rotations round the y axis
export Fys="$allMimosaPlanesFixed $ExcludePlanes" #This is the fixed planes for shifts in the y axis
...
export Fxs="$allMimosaPlanesFixed $ExcludePlanes" #This is the fixed planes for shifts in the x axis
export Fyr="0 1 2 3 4 5 $dutPlanes" #This is the fixed planes for rotations round the y axis
export Fys="$allMimosaPlanesFixed $ExcludePlanes" #This is the fixed planes for shifts in the y axis
export Fzr="$allMimosaPlanesFixed $ExcludePlanes" #This is the fixed planes for rotations round the z axis
export Fzs="0 1 2 3 4 5 $dutPlanes" #This is the fixed planes for shifts in the z axis
...
#export Fys=" $allMimosaPlanesFixed $ExcludePlanes" #This is the fixed planes for shifts in the y axis
#export Fzr=" $allMimosaPlanesFixed $ExcludePlanes" #This is the fixed planes for rotations round the z axis
#export Fzs="$allMimosaPlanesFixed $ExcludePlanes" #This is the fixed planes for shifts in the z axis
#export inputGear="$outputGear"
#export outputGear="$outputGearLast" #IMPORTANT: The last alignment must output the new gear to the output gear name specified. 
#export histoNameInput="Alignment-ZRotations-XYZShifts-Iteration-$number-${RUN}"
#$scriptsLocation/patRecToAlignmentSingleLoop.sh
#$scriptsLocation/patRecAndTrackFit.sh -i "$outputGear" -h "$histoNameInput"  
#
#echo "We have produced new histogram $histoNameInput"
#export Fxr=" $allMimosaPlanesFixed $ExcludePlanes" #This is the fixed planes for rotations round the x axis
