...
# ======================================================================
# ======================================================================
# TestPysubExampleDatura2FEI4: based on config in pysub/examples/datura-2FEI4
# ======================================================================
# ======================================================================

    SET( testdir "${PROJECT_BINARY_DIR}/Testing/test_datura-2FEI4" )
    SET( pysubdir "$ENV{EUTELESCOPE}/pysub" )
    SET( exampledir "${pysubdir}/examples/datura-2FEI4" )
...
#
	ADD_TEST( TestPysubExampleDatura2FEI4Cleanup sh -c "[ -d ${testdir} ] && rm -rf ${testdir} || echo 'no cleanup needed.'" )
	ADD_TEST( TestPysubExampleDatura2FEI4Setup sh -c "mkdir -p ${testdir}/output/histo && mkdir -p ${testdir}/output/results && mkdir -p ${testdir}/output/db && mkdir -p ${testdir}/output/logs && mkdir -p ${testdir}/output/lcio-raw" )
#
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  STEP 1: CONVERTER
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#  - set property DEPENDS to make sure that failure of required steps does not cause following steps to fail as well 
    ...
    ADD_TEST( TestPysubExampleDatura2FEI4ConverterRun sh -c "cd ${testdir} && python ${pysubdir}/${executable} --config=${exampledir}/config.cfg --hot ${RunNr} ${RunNr}" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4ConverterRun PROPERTIES
	...
	DEPENDS TestPysubExampleDatura2FEI4Setup
    )
    # now check if the expected output files exist and look ok
    ADD_TEST( TestPysubExampleDatura2FEI4ConverterLog sh -c "[ -f ${testdir}/output/logs/converter-`printf %06d ${RunNr}`.tar.gz ]" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4ConverterLog PROPERTIES DEPENDS TestPysubExampleDatura2FEI4ConverterRun)

    ADD_TEST( TestPysubExampleDatura2FEI4ConverterHisto sh -c "[ -f ${testdir}/output/histo/run`printf %06d ${RunNr}`-converter-histo.root ]" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4ConverterHisto PROPERTIES DEPENDS TestPysubExampleDatura2FEI4ConverterRun)

    ADD_TEST( TestPysubExampleDatura2FEI4ConverterHotpix sh -c "[ -f ${testdir}/output/db/run${RunNr}-hotpixel-db.slcio ] && lcio_check_col_elements --expelements 6  hotpixel_m26  ${testdir}/output/db/run${RunNr}-hotpixel-db.slcio" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4ConverterHotpix PROPERTIES DEPENDS TestPysubExampleDatura2FEI4ConverterRun)

    ADD_TEST( TestPysubExampleDatura2FEI4ConverterOutput sh -c "[ -f ${testdir}/output/lcio-raw/run`printf %06d ${RunNr}`.slcio ] && lcio_check_col_elements --expelements 6 zsdata_m26 ${testdir}/output/lcio-raw/run`printf %06d ${RunNr}`.slcio" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4ConverterOutput PROPERTIES DEPENDS TestPysubExampleDatura2FEI4ConverterRun)
...
#
    ...
    ADD_TEST( TestPysubExampleDatura2FEI4ClusearchRun sh -c "cd ${testdir} && python ${pysubdir}/${executable} --config=${exampledir}/config.cfg --hot ${RunNr} ${RunNr}" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4ClusearchRun PROPERTIES
        # test will pass if ALL of the following expressions are matched
	...
	# test depends on earlier steps
	DEPENDS TestPysubExampleDatura2FEI4ConverterOutput
	)
    # now check if the expected output files exist and look ok
    ADD_TEST( TestPysubExampleDatura2FEI4ClusearchLog sh -c "[ -f ${testdir}/output/logs/clusearch-`printf %06d ${RunNr}`.tar.gz ]" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4ClusearchLog PROPERTIES DEPENDS TestPysubExampleDatura2FEI4ClusearchRun)
...
#
    ...
    ADD_TEST( TestPysubExampleDatura2FEI4HitmakerRun sh -c "cd ${testdir} && python ${pysubdir}/${executable} --config=${exampledir}/config.cfg -o ${RunNr} run`printf %06d ${RunNr}`-clu-p.slcio" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4HitmakerRun PROPERTIES
        # test will pass if ALL of the following expressions are matched
	...
	# test depends on earlier steps
	DEPENDS TestPysubExampleDatura2FEI4ClusearchOutput
	)
    # now check if the expected output files exist and look ok
    ADD_TEST( TestPysubExampleDatura2FEI4HitmakerLog sh -c "[ -f ${testdir}/output/logs/hitmaker-${RunNr}.tar.gz ]" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4HitmakerLog PROPERTIES DEPENDS TestPysubExampleDatura2FEI4HitmakerRun)
...
#
    ...
    ADD_TEST( TestPysubExampleDatura2FEI4AlignRun sh -c "cd ${testdir} && python ${pysubdir}/${executable} --config=${exampledir}/config.cfg -o ${RunNr} ${RunNr}-hit.slcio" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4AlignRun PROPERTIES
        # test will pass if ALL of the following expressions are matched
	...
	# test depends on earlier steps
	DEPENDS TestPysubExampleDatura2FEI4HitmakerOutput
	)
    # now check if the expected output files exist and look ok
    ADD_TEST( TestPysubExampleDatura2FEI4AlignLog sh -c "[ -f ${testdir}/output/logs/align-${RunNr}.tar.gz ]" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4AlignLog PROPERTIES DEPENDS TestPysubExampleDatura2FEI4AlignRun)
    ...
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4AlignOutput PROPERTIES DEPENDS TestPysubExampleDatura2FEI4AlignRun)
...
#
    ...
    ADD_TEST( TestPysubExampleDatura2FEI4FitterRun sh -c "cd ${testdir} && python ${pysubdir}/${executable} --config=${exampledir}/config.cfg -o ${RunNr} ${RunNr}-hit.slcio -a ${RunNr}-align-db.slcio" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4FitterRun PROPERTIES
        # test will pass if ALL of the following expressions are matched
    ...
    # now check if the expected output files exist and look ok
    ADD_TEST( TestPysubExampleDatura2FEI4FitterLog sh -c "[ -f ${testdir}/output/logs/fitter-${RunNr}.tar.gz ]" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4FitterLog PROPERTIES DEPENDS TestPysubExampleDatura2FEI4FitterRun)

    ADD_TEST( TestPysubExampleDatura2FEI4FitterHisto sh -c "[ -f ${testdir}/output/histo/${RunNr}-track-histo.root ]" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4FitterHisto PROPERTIES DEPENDS TestPysubExampleDatura2FEI4FitterRun)
    ...
    ADD_TEST( TestPysubExampleDatura2FEI4FitterOutput sh -c "[ -f ${testdir}/output/results/${RunNr}-track.slcio ] && lcio_check_col_elements --pedantic --expelements 4 --abselementerror 3 --releventerror .15 track ${testdir}/output/results/${RunNr}-track.slcio" )
    SET_TESTS_PROPERTIES (TestPysubExampleDatura2FEI4FitterOutput PROPERTIES DEPENDS TestPysubExampleDatura2FEI4FitterRun)
