...
## The eta calculation submitter script.
#
# This script is simply defining all the input options for
# the SubmitEta and create an instance of this object.
#
# @author Antonio Bulgheroni, INFN <mailto:antonio.bulgheroni@gmail.com>
# @version $Id: submit-eta.py,v 1.1 2009-05-18 08:58:02 bulgheroni Exp $
...
"""
    ...
    submitEtaCVSVersion = SubmitEta.cvsVersion
    submitBaseCVSVersion = SubmitBase.cvsVersion
    version = "%prog version" + cvsVersion[10:len(cvsVersion)-1] + \
        "\nSubmitEta class version " + submitEtaCVSVersion[10:len(submitEtaCVSVersion)-1] + \
    ...
    parser.add_option( "-o", "--output", type="string", action="store", dest="output", metavar="OUTPUT",
                       ...
                       " ETA DB file ==> OUTPUT-eta-db.slcio, histogram file ==> OUTPUT-eta-histo.root "
                       )
...
from the GRID SE, but the job will be executed on the local CPU
    ...
    try :
        ...
        submitEta._logger.critical( "Cannot continue the execution" )
