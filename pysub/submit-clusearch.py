#! /usr/bin/env python
import os
from pysub import SubmitCluSearch
...
## The cluster search submitter script.
#
# This script is simply defining all the input options for 
# the SubmitClusterSearch and create an instance of this object.
#
# @author Antonio Bulgheroni, INFN <mailto:antonio.bulgheroni@gmail.com>
# @version $Id: submit-clusearch.py,v 1.2 2009-07-28 12:46:38 bulgheroni Exp $
...
"""
    ...
    version = "%prog version" + cvsVersion[10:len(cvsVersion)-1] + \
        "\nSubmitCluSearch class version " + submitCluSearchCVSVersion[10:len(submitCluSearchCVSVersion)-1] + \
...
from the GRID SE, but the job will be executed on the local CPU
    ...
    submitCluSearch = SubmitCluSearch( parser )

    # execute it!
    try :
        submitCluSearch.execute()

    except StopExecutionError, error:
        submitCluSearch._logger.critical( "Cannot continue the execution" )
